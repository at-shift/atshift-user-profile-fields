...
* Official website: [plugins.at-shift.net/en/user-profile-fields](https://plugins.at-shift.net/en/user-profile-fields/)
...
* Confirmed integration with atshift Fields, Feed Builder, Freeform Login, and the UPF Pro add-on.
